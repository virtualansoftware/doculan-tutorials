...
<div class="video-wrap" role="region" aria-label="Demo: Creating a E-Sign">
  ...
  <video controls poster="">
    <source src="https://doculan-storage-public.s3.us-east-1.amazonaws.com/demo_video/Forms/Embbed+Esign.mp4" type="video/mp4">
    <source src="https://doculan-storage-public.s3.us-east-1.amazonaws.com/demo_video/Forms/Embbed+Esign.webm" type="video/webm">
    <!-- Fallback link if browser can't play video -->
    Your browser does not support the video tag. 
    <a href="https://doculan-storage-public.s3.us-east-1.amazonaws.com/demo_video/Forms/Embbed+Esign.mp4" target="_blank" rel="noopener">Download / Open video</a>
  </video>
</div>
