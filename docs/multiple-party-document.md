...
| **Date** | Automatically fills with signing date. |
| **Initial** | Used where each party needs to initial sections. |
| **Attachment** | Allow file uploads. |
| **Clear Fields** | Reset all added elements. |
| **Save E-Sign** | Save your work before sending. |

<details>
  <summary><b>Steps to Add Fields for Multiple Parties</b></summary>

1. Drag and drop a **Signature Field** into the document for each party.  
2. Assign each field to the correct recipient (Party 1, Party 2, etc.).  
3. Repeat for **Date**, **Text**, or any other required fields.  
4. Use different color indicators (if available) to identify which field belongs to which party.  
5. Once done, click **Save E-Sign**.
</details>
...
<details>
  <summary><b>Steps to Save or Update Template</b></summary>
...
6. You can update or delete templates anytime using **Update Template** or **Delete Template** options.
</details>
...
<!-- | **Delete** | Removes from your folder | -->
...
<!-- ###  Signature Options for All Parties
- **Type:** Enter text-based signature.  
- **Draw:** Sign manually using mouse/touchpad.  
- **Upload:** Attach an image file of their signature.
