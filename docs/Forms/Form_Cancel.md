...
This guide explains how to **cancel a form in Doculan** when it is **no longer required**. It walks you through navigating to the form, initiating the cancellation, confirming the action, and reviewing the audit trail for tracking purposes.<br>
...
<img src="screenshots\Forms\Form-Cancel.png" alt="Step 1 — Cancel the Form" style="border:2px solid black; border-radius:4px; width:100%; max-width:800px;">
...
<img src="screenshots\Forms\Form-Cancel1.png" alt="Step 2 — Cancel the Form" style="border:2px solid black; border-radius:4px; width:100%; max-width:800px;">


> Check the **status** after the form is **cancelled.** 

<img src="screenshots\Forms\Form-Cancel2.png" alt="Step 3 — Cancel the Form" style="border:2px solid black; border-radius:4px; width:100%; max-width:800px;">
...
<img src="screenshots\Forms\Form-Cancel3.png" alt="Step 4 — Cancel the Form" style="border:2px solid black; border-radius:4px; width:100%; max-width:800px;">
